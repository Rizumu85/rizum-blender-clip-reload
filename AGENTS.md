...
Project-level instructions for Codex. Combines two behavioral guideline sets: **Karpathy Guidelines** (avoid common LLM coding mistakes) and **Rizum Guidelines** (planning, handoff docs, clear communication).
...
- Prefer `AGENTS.md` for Codex and `AGENTS.md` for Codex. If neither exists, add the line to `plan.md` under `Working Agreement`.
