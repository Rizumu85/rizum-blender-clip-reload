...
fn raster_payload(source: &PreparedSiloSource) -> crate::stream_tile_event::RasterTileEventPayload {
...
fn filter_mask_can_lower<P>(provider: &P, mask_key: Option<GpuMaskResourceKey>) -> bool
where
    P: GpuNormalStackResourceProvider,
{
    match mask_key {
