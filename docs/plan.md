...
- Latest clipped-sibling performance update: direct raster-only child clipping runs inside clipped container/folder sibling child streams now lower through a second local clip-base accumulator. THROUGH children and broader non-raster child subtrees inside clipped siblings remain barriers.
