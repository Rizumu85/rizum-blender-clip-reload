...
- High-leverage native performance work has moved from broad investigation to a
  ...
  compressed raster tile chunks, and shader-side mask atlas events.
  ...
  clipping relationships and containers remain barriers.
