...
_ZH_HANS = _entries({
    ...
    "Packing": "打包中",
    "Pack Error": "打包错误",
    "Import .clip as Rizum Clip Reload image": "将 .clip 导入为 Rizum Clip Reload 图像",
    "Manual Reload": "手动重载",
...
_JA_JP = _entries({
    ...
    "Packing": "パック中",
    "Pack Error": "パックエラー",
    "Import .clip as Rizum Clip Reload image": ".clip を Rizum Clip Reload 画像として読み込み",
...
_ES = _entries({
    ...
    "Import .clip as Rizum Clip Reload image": "Importar .clip como imagen de Rizum Clip Reload",
